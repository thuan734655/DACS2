  ...
  return (
    <div className="flex items-center justify-center h-screen rgb(245, 242, 244)">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
        ...
        {step === 4 && <SuccessMessage title = " Your password has been changed successfully!"  desc = "You can now log in with your new password." textNav = "Back to Login" nextPage= "/login"  navigate={navigate} />}
      </div>
    </div>
  );
};
