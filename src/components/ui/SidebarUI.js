...
import { FaUserFriends, FaUsers, FaClock, FaBookmark, FaVideo, FaStore, FaNewspaper } from 'react-icons/fa';
...
const Sidebar = () => {
  return (
    <div className="w-70 h-0 ">
      ...
      {/* Show More */}
      <div className="mt-4">
        <button className="flex items-center space-x-2 text-gray-600 hover:text-blue-600 hover:bg-gray-100 p-2 rounded-lg w-full">
          <span>Xem thêm</span>
        </button>
      </div>
